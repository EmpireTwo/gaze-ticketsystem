...
class TicketCreate extends Component
{
    ...
    public function mount(): void
    {
        ...
        if (request()->query('prefill') && is_string($sourceType) && $sourceType !== '' && $sourceId !== null) {
    ...
    public function save(): void
    {
        ...
        $this->redirect(route('gaze-ticketsystem.tickets.show', $ticket), navigate: true);
    }
    ...
    public function prefillFromSource(string $sourceType, mixed $sourceId): void
    {
        ...
        if (is_string($data->body) && $data->body !== '') {
            $this->body = $data->body;
        }
    ...
    {
        return view('gaze-ticketsystem::ticket-create')
            ->layout($this->layout());
    }
